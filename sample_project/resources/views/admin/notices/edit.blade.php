...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.notices.index') }}" class="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            &larr; Back to Notices
        </a>
    </div>

    <form action="{{ route('admin.notices.update', $notice->id) }}" method="POST" class="bg-white dark:bg-neutral-900 shadow-sm border border-gray-200 dark:border-neutral-800 rounded-md p-6 space-y-6">
        @csrf
        @method('PUT')
