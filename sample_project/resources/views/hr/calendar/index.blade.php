    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function initCalendar() {
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function(fetchInfo, successCallback, failureCallback) {
                    const url = new URL('{{ route("hr.calendar.events") }}', window.location.origin);
        ...
        function updateAgendaList(eventsData) {
            ...
            todayEvents.forEach(event => {
                ...
                // Attach click listener to the button specifically if needed, or rely on card click.
                // Since the user asked for a button, we provide it.
                // We'll stop propagation on the button to prevent double formatting if we were doing logic,
                // but here letting it bubble or handling it is fine.
                // Let's rely on the card's onclick for simplicity as it covers the whole row.
                // But to be precise with "Action Button", we can make the button standard.
