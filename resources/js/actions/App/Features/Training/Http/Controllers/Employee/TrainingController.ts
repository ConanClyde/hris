 ...
 * @see app/Features/Training/Http/Controllers/Employee/TrainingController.php:101
...
const TrainingController = { index, store, update, destroy, exportMethod, deleteAttachment, export: exportMethod }
