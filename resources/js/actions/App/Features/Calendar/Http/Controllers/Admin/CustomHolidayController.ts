 ...
 * @see app/Features/Calendar/Http/Controllers/Admin/CustomHolidayController.php:21
 ...
 * @see app/Features/Calendar/Http/Controllers/Admin/CustomHolidayController.php:26
 * @route '/admin/custom-holidays'
 */
 ...
 * @see app/Features/Calendar/Http/Controllers/Admin/CustomHolidayController.php:79
 ...
 * @see app/Features/Calendar/Http/Controllers/Admin/CustomHolidayController.php:136
 * @route '/admin/custom-holidays/{custom_holiday}'
 */
...
const CustomHolidayController = { index, store, update, destroy }

export default CustomHolidayController