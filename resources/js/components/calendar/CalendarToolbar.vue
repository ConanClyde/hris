...
<template>
    <div class="grid grid-cols-1 shrink-0 items-center gap-4 border-b border-border bg-card p-4 md:grid-cols-3">
        <div class="flex items-center justify-self-center gap-2 md:justify-self-start">
        ...
        <div class="flex items-center justify-self-center gap-2 md:justify-self-end">
            <div class="inline-flex rounded-md border border-border bg-card">
                <button
                    ...
                    :aria-current="calendar.view.value === v.value ? 'true' : undefined"
                    :class="[
                        'px-4 py-2 text-sm font-medium transition-colors',
                        calendar.view.value === v.value
                            ? 'bg-muted text-foreground'
                            : 'text-muted-foreground hover:bg-muted hover:text-foreground',
                        index === 0 ? 'rounded-l-md border-r border-border' : '',
                        index === viewLabels.length - 1 ? 'rounded-r-md' : 'border-r border-border',
                    ]"
                >
                    {{ v.label }}
                </button>
