...
import { addDays, addMonths, format, isSameDay, isSameMonth, setMonth, startOfMonth, startOfWeek } from 'date-fns';
...
<template>
    <div class="h-full overflow-auto rounded-lg border border-border bg-card p-4">
        <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
            ...
            >
                <div class="mb-2 text-center text-sm font-semibold text-foreground">
                    {{ format(month, 'MMMM') }}
                </div>
                <div class="grid grid-cols-7 text-[10px]">
                    ...
                    <div
                        ...
                        :class="{
                            ...
                            'bg-primary text-primary-foreground font-semibold': isToday(day),
                        }"
                    >
                        {{ format(day, 'd') }}
                    </div>
