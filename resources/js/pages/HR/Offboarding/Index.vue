...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Offboarding' }];
...
function updateClearance(clearanceId: number, status: string) {
    router.post(`/hr/offboarding/clearance/${clearanceId}`, {
        status,
        remarks: '',
    });
}
        ...
        <div class="mx-auto w-full max-w-5xl space-y-6 p-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Manage employee clearance processes during resignations and
                    separations.
                </p>
            </div>
            ...
            >
                ...
                <p class="mt-1 text-xs text-gray-400">
                    Initialize clearance from an employee's profile when needed.
                </p>
            </div>
                ...
                >
                    ...
                    >
                        <div class="flex items-center gap-4">
                            <div
                                class="flex size-10 items-center justify-center rounded-full bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400"
                            >
                    ...
                    <div
                        ...
                        class="border-t border-gray-200 dark:border-neutral-700"
                    >
                        <div
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    >
                                        <Button
                                            ...
                                            class="h-7 text-xs"
                                            @click.stop="
                                                updateClearance(c.id, 'cleared')
                                            "
                                        >
                                            Clear
                                        </Button>
                                        <Button
                                            v-if="c.status !== 'flagged'"
                                            size="sm"
                                            variant="outline"
                                            class="h-7 text-xs text-red-600"
                                            @click.stop="
                                                updateClearance(c.id, 'flagged')
                                            "
                                        >
                                            Flag
                                        </Button>
