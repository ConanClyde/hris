            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-[260px_1fr_320px]">
                <aside class="hidden lg:block">
                    ...
                    >
                        ...
                        >
                            Use search to find announcements.
                        </p>
                        <div
                            class="mt-4 space-y-2 text-xs text-gray-600 dark:text-gray-300"
                        >
                            <div
                                class="rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-neutral-700 dark:bg-neutral-900"
                            >
                                All announcements
                            </div>
                            <div
                    ...
                    <div v-if="hasPosts" class="space-y-4">
                        ...
                        >
                            <PostCard
                                ...
                                @react="
                                    ({ postId, type }) => react(postId, type)
                                "
                                @update:commentDraft="
                                    (v) => (commentDrafts[post.id] = v)
                                "
                                @submitComment="
                                    ({ postId }) => submitComment(postId)
                                "
                            />
                        </div>
                    </div>
