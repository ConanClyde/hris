...
const children = ref<PdsChild[]>(
    ((props.pds as any)?.children ?? []).map((c: any) => ({
        name: c?.name ?? '',
        dob: c?.dob ? String(c.dob).slice(0, 10) : '',
    })),
);

const education = ref<PdsEducation[]>(
    ((props.pds as any)?.education ?? []).map((e: any) => ({
        level: e?.level ?? '',
...
const cscEligibility = ref<PdsCscEligibility[]>(
    (
        (props.pds as any)?.csc_eligibility ??
        (props.pds as any)?.cscEligibility ??
        []
    ).map((r: any) => ({
        license_name: r?.license_name ?? '',
        rating: r?.rating ?? '',
        date_of_examination: r?.date_of_examination
            ? String(r.date_of_examination).slice(0, 10)
            : '',
        place_of_examination: r?.place_of_examination ?? '',
        license_no: r?.license_no ?? '',
        date_of_validity: r?.date_of_validity
            ? String(r.date_of_validity).slice(0, 10)
            : '',
    })),
);

const workExperience = ref<PdsWorkExperience[]>(
    (
        (props.pds as any)?.work_experience ??
        (props.pds as any)?.workExperience ??
        []
    ).map((w: any) => ({
        employed_from: w?.employed_from
            ? String(w.employed_from).slice(0, 10)
            : '',
...
const voluntaryWork = ref<PdsVoluntaryWork[]>(
    (
        (props.pds as any)?.voluntary_work ??
        (props.pds as any)?.voluntaryWork ??
        []
    ).map((v: any) => ({
        org_name_address: v?.org_name_address ?? '',
        volunteer_from: v?.volunteer_from
            ? String(v.volunteer_from).slice(0, 10)
            : '',
        volunteer_to: v?.volunteer_to
            ? String(v.volunteer_to).slice(0, 10)
            : '',
...
const training = ref<PdsTraining[]>(
    ((props.pds as any)?.training ?? []).map((t: any) => ({
        title: t?.title ?? '',
        training_from: t?.training_from
            ? String(t.training_from).slice(0, 10)
            : '',
...
const otherInfo = ref<PdsOtherInfo[]>(
    ((props.pds as any)?.other_info ?? (props.pds as any)?.otherInfo ?? []).map(
        (o: any) => ({
            skills: o?.skills ?? '',
...
const references = ref<PdsReference[]>(
    ((props.pds as any)?.references ?? []).map((r: any) => ({
...
const isRevisionPending = computed(
    () => props.pendingRevision?.status === 'pending',
);
const isRevisionDraft = computed(
    () => props.pendingRevision?.status === 'draft',
);
...
async function handlePdfUpload(event: Event) {
    ...
    toast.info('Extracting PDS data via AI...', {
    ...
    try {
        ...
        if (result.success && result.data) {
            ...
            toast.success('PDS successfully auto-filled!', {
                description:
                    'Please review all extracted fields carefully before saving.',
            });
        }
    } catch (error: any) {
...
function mapExtractedData(data: any) {
    ...
    if (data.personal) {
        Object.assign(form, {
            ...
            agency_employee_no:
                data.personal.agency_employee_no || form.agency_employee_no,
            citizenship_type:
                data.personal.citizenship || form.citizenship_type,
        ...
        if (form.residential_address !== undefined) {
            form.residential_address!.house_no =
                data.personal.residential_house_block_no ||
                form.residential_address!.house_no;
            form.residential_address!.street =
                data.personal.residential_street ||
                form.residential_address!.street;
            form.residential_address!.subdivision =
                data.personal.residential_subdivision_village ||
                form.residential_address!.subdivision;
            form.residential_address!.barangay =
                data.personal.residential_barangay ||
                form.residential_address!.barangay;
            form.residential_address!.city =
                data.personal.residential_city_municipality ||
                form.residential_address!.city;
            form.residential_address!.province =
                data.personal.residential_province ||
                form.residential_address!.province;
            form.residential_address!.zip_code =
                data.personal.residential_zipcode ||
                form.residential_address!.zip_code;
        }

        if (form.permanent_address !== undefined) {
            form.permanent_address!.house_no =
                data.personal.permanent_house_block_no ||
                form.permanent_address!.house_no;
            form.permanent_address!.street =
                data.personal.permanent_street ||
                form.permanent_address!.street;
            form.permanent_address!.subdivision =
                data.personal.permanent_subdivision_village ||
                form.permanent_address!.subdivision;
            form.permanent_address!.barangay =
                data.personal.permanent_barangay ||
                form.permanent_address!.barangay;
            form.permanent_address!.city =
                data.personal.permanent_city_municipality ||
                form.permanent_address!.city;
            form.permanent_address!.province =
                data.personal.permanent_province ||
                form.permanent_address!.province;
            form.permanent_address!.zip_code =
                data.personal.permanent_zipcode ||
                form.permanent_address!.zip_code;
        }
    }
    ...
    if (data.family) {
        Object.assign(family, {
            ...
            spouse_first_name:
                data.family.spouse_first_name || family.spouse_first_name,
            spouse_middle_name:
                data.family.spouse_middle_name || family.spouse_middle_name,
            spouse_name_extension:
                data.family.spouse_name_extension ||
                family.spouse_name_extension,
            spouse_occupation:
                data.family.spouse_occupation || family.spouse_occupation,
            spouse_employer:
                data.family.spouse_employer_business_name ||
                family.spouse_employer,
            spouse_business_address:
                data.family.spouse_business_address ||
                family.spouse_business_address,
            spouse_telephone:
                data.family.spouse_telephone_no || family.spouse_telephone,
            father_surname: data.family.father_surname || family.father_surname,
            father_first_name:
                data.family.father_first_name || family.father_first_name,
            father_middle_name:
                data.family.father_middle_name || family.father_middle_name,
            father_name_extension:
                data.family.father_name_extension ||
                family.father_name_extension,
            mother_maiden_surname:
                data.family.mother_maiden_surname ||
                family.mother_maiden_surname,
            mother_maiden_first_name:
                data.family.mother_first_name ||
                family.mother_maiden_first_name,
            mother_maiden_middle_name:
                data.family.mother_middle_name ||
                family.mother_maiden_middle_name,
        });
    }
    ...
    if (
        data.csc_eligibility &&
        Array.isArray(data.csc_eligibility) &&
        data.csc_eligibility.length > 0
    ) {
    ...
    if (
        data.voluntary_work &&
        Array.isArray(data.voluntary_work) &&
        data.voluntary_work.length > 0
    ) {
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-full max-w-7xl space-y-5 p-4">
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Fill in your personal information and submit for HR
                        review.
                    </p>
                </div>
                ...
                <!-- Revision Banners -->
                <div
                    v-if="isRevisionPending"
                    class="mt-4 max-w-7xl rounded-md border border-amber-200 bg-amber-50 p-4 dark:border-amber-900/50 dark:bg-amber-900/20"
                >
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            >
                                <p>
                                    You have submitted a revision request for
                                    your PDS. Your requested changes are shown
                                    below and are currently locked until HR
                                    reviews them. If you wish to make further
                                    changes, please wait for HR's decision.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    v-else-if="isRevisionDraft"
                    class="mt-4 max-w-7xl rounded-md border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/50 dark:bg-blue-900/20"
                >
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <Save
                        ...
                        <div class="ml-3">
                            ...
                            >
                                <p>
                                    You have an unsubmitted draft for your PDS
                                    revision. Submit it when you are ready to
                ...
                <div class="flex shrink-0 flex-wrap items-center gap-2">
                    ...
                    <Button
                        ...
                        type="button"
                        variant="default"
                        class="gap-2 bg-indigo-600 text-white shadow-sm shadow-indigo-200 hover:bg-indigo-700 dark:shadow-none"
                    ...
                    <Badge
                        ...
                        class="gap-1.5 px-3 py-1.5 text-sm capitalize"
                    >
                        <CheckCircle2
                    ...
                    <a
                        ...
                        target="_blank"
                        class="inline-flex h-9 items-center gap-2 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-200 dark:hover:bg-neutral-700"
                    >
                        <FileText class="size-4 text-red-500" /> Export to CS
                        Form 212
                    </a>
                    <Link
                        v-if="pds?.id"
            ...
            <div class="-mx-4 px-4">
                <div
                    class="inline-flex overflow-hidden rounded-md border border-gray-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900"
                    role="tablist"
                >
                    <button
                        type="button"
                        class="border-r border-gray-200 px-5 py-2.5 text-sm font-medium dark:border-neutral-800"
                        :class="
                            activeTab === 'c1'
            ...
            >
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-amber-700 dark:text-amber-400">
                        Your PDS was submitted
                        {{ formatDate(pds?.submitted_at ?? null) }}. You cannot
                        edit while under review.
                    </p>
                </div>
            </div>
            <div
            ...
            >
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-emerald-700 dark:text-emerald-400">
                        Your PDS was approved
                        {{ formatDate(pds?.reviewed_at ?? null) }}. Contact HR
                        to make changes.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-red-700 dark:text-red-400">
                        HR returned your PDS. Please update and resubmit.
                    </p>
                    <p
                        v-if="pds?.remarks"
            ...
            <div v-show="activeTab === 'c1'" class="space-y-5">
                ...
                >
                    ...
                    <Transition name="collapse">
                        <div
                            v-show="openSections.personal"
                            class="bg-white p-5 dark:bg-neutral-900"
                        >
                            <div
                            ...
                            >
                                ...
                                <div class="space-y-1.5">
                                    <Label for="citizenship_type"
                                        >Citizenship</Label
                                    >
                                    <Select
                                        v-model="form.citizenship_type"
                                        :disabled="!canEdit"
                                    >
                                        <SelectTrigger id="citizenship_type"
                                            ><SelectValue placeholder="Select"
                                        /></SelectTrigger>
                                        <SelectContent>
                                            ...
                                            <SelectItem value="Dual"
                                                >Dual citizenship</SelectItem
                                            >
                                        </SelectContent>
                                    </Select>
                                </div>
                                <div
                                    v-if="form.citizenship_type === 'Dual'"
                                ...
                                >
                                    ...
                                    <Input
                                        ...
                                        :disabled="!canEdit"
                                        placeholder="Country of dual citizenship"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <Transition name="collapse">
                        ...
                        >
                            ...
                            >
                                <div class="space-y-1.5">
                                    <Label for="cs_id"
                                        >CS / Plantilla No.</Label
                                    >
                                    <Input
                                        id="cs_id"
                                        v-model="form.cs_id"
                                        :disabled="!canEdit"
                                        placeholder="Civil Service / Plantilla No."
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    ...
                                    <Input
                                        ...
                                        v-model="form.agency_employee_no"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    ><Input
                                        v-model="family.spouse_first_name"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    ...
                                    ><Input
                                        v-model="family.spouse_middle_name"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    ...
                                    ><Input
                                        v-model="family.spouse_name_extension"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                ...
                                <div class="space-y-1.5 sm:col-span-2">
                                    ...
                                    ><Input
                                        v-model="family.spouse_employer"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5 sm:col-span-2">
                                    ...
                                    ><Input
                                        v-model="family.spouse_business_address"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5 sm:col-span-2">
                                    ...
                                    ><Input
                                        v-model="family.spouse_telephone"
                                        :disabled="!canEdit"
                                    />
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    ><Input
                                        v-model="family.father_first_name"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    ...
                                    ><Input
                                        v-model="family.father_middle_name"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    <Label>Father Name Ext.</Label
                                    ><Input
                                        v-model="family.father_name_extension"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                                    <Label>Mother Maiden Surname</Label
                                    ><Input
                                        v-model="family.mother_maiden_surname"
                                        :disabled="!canEdit"
                                    />
                                </div>
                                <div class="space-y-1.5">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="overflow-x-auto">
                                    <table
                                        class="min-w-full border border-gray-200 text-sm dark:border-neutral-700"
                                    >
                                        <thead
                                        ...
                                        >
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="e.level"
                                                    :disabled="!canEdit"
                                                    placeholder="Elementary/Secondary/etc"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="e.school_name"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="e.degree_course"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="e.year_graduated"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                ...
                <div
                    v-if="canEdit"
                    class="flex flex-wrap items-center justify-end gap-3 pt-1"
                >
                    <p class="mr-auto text-xs text-muted-foreground">
                        Last updated: {{ formatDate(pds?.updated_at ?? null) }}
                    </p>
                    <Button
                        type="button"
                        variant="outline"
            ...
            <div v-show="activeTab === 'c2'" class="space-y-5">
                ...
                >
                    ...
                    >
                        <span
                            class="text-sm font-semibold text-gray-900 dark:text-gray-100"
                            >Civil Service Eligibility</span
                        >
                        <span class="ml-auto inline-flex items-center">
                            <ChevronUp
                                v-if="openSections.csc"
                                class="size-4 text-muted-foreground"
                            />
                            <ChevronDown
                                v-else
                        ...
                        >
                            ...
                            <div class="overflow-x-auto">
                                ...
                                >
                                    ...
                                    >
                                        <tr
                                            v-for="(r, i) in cscEligibility"
                                            :key="i"
                                        >
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="r.license_name"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="w.position_title"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="w.department"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <select
                                                    v-model="w.is_government"
                                                    :disabled="!canEdit"
                                                    class="h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                                                >
                                                    <option :value="false">
                                                        N
                                                    </option>
            ...
            <div v-show="activeTab === 'c3'" class="space-y-5">
                        ...
                        >
                            ...
                            <div class="overflow-x-auto">
                                ...
                                >
                                    ...
                                    >
                                        <tr
                                            v-for="(v, i) in voluntaryWork"
                                            :key="i"
                                        >
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="v.org_name_address"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="v.volunteer_from"
                                                    type="date"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                ...
                >
                    ...
                    <Transition name="collapse">
                        <div
                            v-show="openSections.training"
                            class="bg-white p-5 dark:bg-neutral-900"
                        >
                            <p class="mb-3 text-xs text-muted-foreground">
                                Synced from Training module (approved only). To
                                edit, update your training record in the
                                Training page.
                            </p>
                            <div class="overflow-x-auto">
                                <table
            ...
            <div v-show="activeTab === 'c4'" class="space-y-5">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="o.recognition"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2">
                                                <Input
                                                    v-model="o.membership"
                                                    :disabled="!canEdit"
                                                />
                                            </td>
                                            <td class="px-3 py-2 text-right">
                ...
                >
                    ...
                    >
                        <span
                            class="text-sm font-semibold text-gray-900 dark:text-gray-100"
                            >References (max 3)</span
                        >
                        <span class="ml-auto inline-flex items-center">
                            <ChevronUp
                                v-if="openSections.references"
                                class="size-4 text-muted-foreground"
                            />
                            <ChevronDown
                                v-else
                    ...
                    <Transition name="collapse">
                        <div
                            v-show="openSections.references"
                            class="bg-white p-5 dark:bg-neutral-900"
                        >
                            <div class="overflow-x-auto">
                                <table
            ...
            <Dialog v-model:open="submitDialogOpen">
                <DialogContent :show-close-button="true" class="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Confirm submission of your Personal Data Sheet for
                            HR review.
                        </DialogDescription>
                    </DialogHeader>
                    <div class="max-h-[60vh] space-y-4 overflow-y-auto p-1">
                        <p class="text-sm text-muted-foreground">
                            Once submitted, you will not be able to edit your
                            PDS until HR reviews it. Make sure all information
                    ...
                    <DialogFooter>
                        <Button
                            ...
                            >Cancel</Button
                        >
                        <Button type="button" @click="submitPds"
                            >Yes, submit</Button
                        >
                    </DialogFooter>
                </DialogContent>
