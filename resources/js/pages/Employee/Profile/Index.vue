...
function submitEditProfile() {
    ...
    router.post(employee.profile.update.url(), formData, {
        forceFormData: true,
        onSuccess: () => {
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_320px]">
                ...
                <div>
                    <Card>
                        ...
                        <Button class="w-full text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300" variant="outline" @click="deleteModalOpen = true">
                            Delete account
                        </Button>
                        </CardContent>
                    </Card>
