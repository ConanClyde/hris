...
<template>
    ...
    <div
        class="flex min-h-dvh flex-col items-center bg-[#FDFDFC] p-4 pb-[env(safe-area-inset-bottom)] text-[#1b1b18] sm:p-6 lg:justify-center lg:p-8 dark:bg-[#0a0a0a]"
    >
        <header
            class="mb-6 w-full min-w-0 max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl"
        >
        ...
        >
            <main
                class="flex w-full min-w-0 max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row"
            >
                <div
