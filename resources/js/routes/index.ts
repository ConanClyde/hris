...
export const aiChatbot = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: aiChatbot.url(options),
    method: 'get',
})

aiChatbot.definition = {
    methods: ["get","head"],
    url: '/ai-chatbot',
} satisfies RouteDefinition<["get","head"]>
...
aiChatbot.url = (options?: RouteQueryOptions) => {
    return aiChatbot.definition.url + queryParams(options)
}
