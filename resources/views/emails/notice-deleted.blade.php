...
<body>
    <div class="container">
        <div class="header">
            <h1>Notice Removed</h1>
        </div>
        
        <div class="content">
            <p>Dear <strong>All</strong>,</p>
            
            <p>A notice has been removed from the system. Please be advised that the following notice is no longer active:</p>
            
            <div class="warning">
                <h3>Removed Notice Details</h3>
                <p><strong>Title:</strong> {{ $noticeTitle }}</p>
                <p><strong>Category:</strong> {{ $noticeCategory }}</p>
                <p><strong>Removed Date:</strong> {{ $removedDate }}</p>
                <p><strong>Removed By:</strong> {{ $removedBy }}</p>
            </div>
            
            <p>If you have any questions regarding this removal, please contact the HR department.</p>
