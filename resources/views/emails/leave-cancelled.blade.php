...
<body>
    <div class="container">
        <div class="header">
            <h1>Leave Application Cancelled</h1>
        </div>
        
        <div class="content">
            <p>Dear <strong>{{ $employeeName }}</strong>,</p>
            
            <p>Your leave application has been successfully <span class="status-badge">CANCELLED</span>.</p>
            ...
            <p>If you need to submit a new leave application, you can do so through the HRIS portal.</p>
            
            <p>Thank you for using the HRIS system.</p>
